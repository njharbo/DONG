\begin{landscape}
\begin{figure}
\caption[]{Spiltrae for option outside money. I hver tom node tager staten en beslutning. I hver fyldt tager NEI en beslutning. En firkantet node er blot et forbindelsespunkt}
\begin{tikzpicture}
