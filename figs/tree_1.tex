...
\begin{figure}
\label{fig:tree_1}
\caption[]{Spiltrae hvis aktiepris $>$ garanteret tilbagekobspris. I hver tom node tager staten en beslutning. I hver fyldt node tager NEI en beslutning. En firkantet node er blot et forbindelsespunkt}
\begin{tikzpicture}
