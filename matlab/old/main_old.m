...
ylabel('Mia. DKK')
xlabel('?rlig forrentning i procent af DONGs egenkapital')
%axis([-30 30 -5 5])
...
ylabel('Mia. DKK')
xlabel('?rlig forrentning i procent')
...
ylabel('Mia. DKK')
xlabel('Gennemsnitlig ?rlig v?kst i markedsv?rdi af egenkapital (%)')
subplot(2,1,2)
hist(return_msci_sim,100)
title('Figur 2: Fordeling af 10 000 simuleringer af afkast p? aftalen ift. et statsligt kapital indskud', 'Fontsize', 12)
ylabel('Antal')
