...
function [payment,stock,emmision, share]=gs(sand, indskud, initial, n, keep, g,r, inigovshare)
if (1+g)^n*0.6*indskud>0.6*indskud/(indskud+initial)*(sand+indskud)*(1+r)^n
